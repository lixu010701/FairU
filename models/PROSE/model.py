"""
PROSE backbone models: GCN_Sparse, Anchor_GraphEncoder, Anchor_GCL.
...
class GCN_Sparse(nn.Module):
    """Sparse GCN classifier using AnchorGCNLayer."""
...
class Anchor_GraphEncoder(nn.Module):
    """Graph encoder with anchor-based message passing and projection head."""

    def __init__(self, nlayers, in_dim, hidden_dim, emb_dim, proj_dim,
                 dropout, dropout_adj, batch_norm=False, sparse=False):
